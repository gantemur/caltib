...
TRANSLATIONS = {
    ...
    "bo": { # Tibetan
        ...
        "day_card_greg_fmt": "ཕྱི་ལོ་ {year} ཟླ་ {month} ཚེས་ {day}",
    ...
    "mn": { # Mongolian (Cyrillic)
        ...
        "tib_month_long_fmt": "{year} он, {month} {element} {animal} сар",
        "rabjung_fmt": "{R}-р жарны {Y}-р он {element} {animal} жил",
        "greg_date_lbl": "Аргын өдөр",
        "weekdays_long": ["Даваа", "Мягмар", "Лхагва", "Пүрэв", "Баасан", "Бямба", "Ням"],
        "day_card_greg_fmt": "{year} оны {month} сарын {day}",
        "rabjung_title": "Жарны дугаар",
